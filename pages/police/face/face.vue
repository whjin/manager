<template>
  <div class="face-container" @touchstart.stop="initCountTimer">
          ...
          <div v-if="currentPage == 2" class="face-record-container">
            <div class="record-form-content">
              <div class="face-form-box">
                ...
                <div class="face-select">
                  <label>面对面民警：</label>
                  <xfl-select :list="policeList" :initValue="policeInfo.value" clearable :placeholder="'请选择面对面民警'"
                    @change="selectPolice" @clear="clearSelectPolice"></xfl-select>
                </div>
                <div class="face-select">
                  <label>登记时间：</label>
            ...
            <div class="record-table-box">
              ...
              <scroll-view scroll-y="true" class="record-table-scroll">
                <div class="table-content" v-for="(item, index) in faceRecordList" :key="index">
                  ...
                  <div class="record-table-item" style="flex: 1" @click="getFaceDetailInfo(item)">查看详情</div>
                </div>
              </scroll-view>
            </div>
          </div>
