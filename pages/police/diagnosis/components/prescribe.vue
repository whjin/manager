        ...
        <view class="form" :class="{ cushion: addCushion }">
          ...
          <view class="form-row">
            ...
            <view class="form-col col-2">
              ...
              <!-- 详情：症状 -->
              <scroll-view v-if="isShowDetails"
                           scroll-x
                           style="width: auto;">
              ...
              <!-- 表单 -->
              <input v-else
                     class="inside-border input"
                     :class="{
                       'lack-val': !medicineParams.symptom
                     }"
                     v-model="medicineParams.symptom"
                     type='text'
                     placeholder="请输入症状/主诉" />
            </view>
          </view>
          <!-- 药物过敏/处方时间 -->
          <view class="form-row">
            <view class="form-col">
              ...
              <input v-else
                     ...
                     v-model="medicineParams.allergy"
                     type='text'
                     placeholder="请输入药物过敏" />
            </view>
            <view class="form-col col-2">
          ...
          <view class="form-row" v-if="(isShowDetails && details.dataSource === '1') || !isShowDetails">
            <view class="form-col">
              ...
              <view v-else
                ...
                <fuzzySearch placeholder="请选填疾病类型"
                             ref="diseaseType"
                             useFor="DiseaseType"
                             @selected="selectDiseaseType" />
              </view>
            </view>
            <view class="form-col col-2">
              <view class="fields">
              ...
              <view v-else
                ...
                <fuzzySearch placeholder="请选填特殊病"
                             ref="special"
                             useFor="Special"
              ...
              <view class="physique-info">
                <view class="physique-info-details">
                  ...
                  <input class="inside-border input"
                         v-model="details.bodyTemperature"
                         type="number"
                         disabled>
                  ℃
                </view>
          ...
          <view class="form-row" v-if="(isShowDetails && details.dataSource === '1') || !isShowDetails">
            <view class="form-col">
              ...
              <input v-else
                     class="inside-border input"
                     style="width: 960.417upx;"
                     v-model="medicineParams.commonCheck"
                     type='text'
                     placeholder="请输入一般检查" />
            </view>
          </view>
          <view class="form-row">
            <view class="form-col">
              ...
              <input v-else
                     ...
                     style="width: 960.417upx;"
                     v-model="medicineParams.diagnosis"
                     type='text'
                     placeholder="请输入初步诊断" />
            </view>
          </view>
          <view class="form-row" v-if="(isShowDetails && details.dataSource === '1') || !isShowDetails">
            <view class="form-col col-2">
              ...
              <view v-else class="cure-wrapper">
                <input class="inside-border input"
                       v-model="medicineParams.cure"
                       type='text'
                       placeholder="请选填治疗方案"
                       @focus="showCureSchemeList = true"
                       @input="showCureSchemeList = false" />
                <view class="cure-scheme-list inside-border" v-show="showCureSchemeList">
                  <view class="cure-scheme-item"
                        v-for="(cure, index) in cureSchemeList"
                        :key="index"
                        @click="selectCureScheme(cure)">
                    {{ cure.field_name }}
                  </view>
                </view>
              </view>
            ...
            <view class="form-col">
              ...
              <view class="prescription-wrapper">
                ...
                <view v-if="isShowDetails" class="prescription">
                  ...
                  <ul class="list">
                    <li class="list-row"
                        v-for="(i, index) in details.recipeList"
                        :key="index">
                ...
                <prescription v-else
                              ...
                              :outDate="prescribeTime"
                              @updateRecipe="setRecipeParams"
                              @inputFoucus="inputFoucus"
                              @inputBlur="inputBlur" />
              </view>
            </view>
          </view>
          ...
          <template v-if="!isShowDetails">
            <view class="form-row">
              <view class="form-col">
                ...
                <radio-group @change="setPrescriptionObserve"
                             class="input">
              ...
              <view class="form-col col-2"
                    :class="{ hid: prescriptionParams.isObserve === '0' }">
                <view class="fields req">
            ...
            <view class="form-row"
                  v-if="prescriptionParams.isObserve === '1'">
              <view class="form-col">
                <view class="fields req">
                  <text class="text">注射类型：</text>
                </view>
                <radio-group @change="setInjectionType"
                             class="input"
                             style="width: 960.417upx;">
                  <label class="form-label">
            ...
            <view class="form-row"
              ...
              <view class="form-col">
                ...
                <view class="prescription-wrapper">
                  <prescription view="observe"
                                ref="transfuseList"
                                :outDate="prescribeTime"
                                :isNeedGrouping="true"
                                @updateRecipe="setObserveParams"
                                @inputFoucus="inputFoucus"
                                @inputBlur="inputBlur" />
                </view>
              </view>
            ...
            <view class="form-row">
              <view class="form-col">
                ...
                <radio-group class="input">
                  <label class="form-label">
                    <radio value="1"
                           :checked="details.isObserve === '1'"
                           disabled />
                    <view class="label-text">是</view>
                  </label>
                  <label class="form-label">
                    <radio value="0"
                           :checked="details.isObserve === '0'"
                           disabled />
                    <view class="label-text">否</view>
                  </label>
                </radio-group>
            ...
            <view class="form-row"
              ...
              <view class="form-col">
                ...
                <radio-group class="input"
                  ...
                  <label class="form-label">
                    <radio value="1"
                           :checked="details.injectionType === '1'"
                           disabled />
                    <view class="label-text">皮下注射</view>
                  </label>
                  <label class="form-label">
                    <radio value="2"
                           :checked="details.injectionType === '2'"
                           disabled />
                    <view class="label-text">肌肉注射</view>
                  </label>
                  <label class="form-label">
                    <radio value="3"
                           :checked="details.injectionType === '3'"
                           disabled />
                    <view class="label-text">静脉静推</view>
                  </label>
                  <label class="form-label">
                    <radio value="4"
                           :checked="details.injectionType === '4'"
                           disabled />
                    <view class="label-text">静脉滴注</view>
                  </label>
                </radio-group>
              ...
              <view class="form-col">
                ...
                <view class="prescription-wrapper">
                  <view class="prescription">
                    ...
                    <ul class="list">
                      <li class="list-row"
                          v-for="(i, index) in details.transfuseList"
                          :key="index">
                        <view class="list-col flex-2">
                          {{ i.drugName }}
                        </view>
          ...
          <view v-if="!isShowDetails" class="form-row">
            ...
            <view class="form-col col-2"
                  :class="{ hid: prescriptionParams.isNeed === '0' }">
              <view class="fields req">
          ...
          <view v-else-if="isShowDetails && details.dataSource === '1'" class="form-row">
            <view class="form-col">
              ...
              <radio-group class="input">
                <label class="form-label">
                  <radio value="1"
                         :checked="details.isNeed === '1'"
                         disabled />
                  <view class="label-text">是</view>
                </label>
                <label class="form-label">
                  <radio value="0"
                         :checked="details.isNeed === '0'"
                         disabled />
                  <view class="label-text">否</view>
                </label>
              </radio-group>
          ...
          <view class="form-row">
            ...
            <view class="form-col col-2">
              ...
              <!-- 详情：巡诊时间 -->
              <view v-if="isShowDetails" 
                    class="inside-border input"
                    style="margin-right: 362.5upx; width: 236.2upx;">{{ details.treatTime | dateFormatFilter }}</view>
              <!-- 表单 -->
              <view v-else
                    class="inside-border input"
                    style="margin-right: 362.5upx; width: 236.2upx;">{{ medicineParams.treatTime }}</view>
            </view>
          </view>
          <view v-if="!isShowDetails" class="form-row">
...
export default {
  ...
  methods: {
    ...
    handleTemplateChange (e) {
      this.curTemplate = e.orignItem.id;
    },
