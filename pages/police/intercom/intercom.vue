					...
					<div class="volume-modal-content">
						<div class="volume-modal-section">
							...
							<div class="volume-slider">
								<slider :value="managerVolume" max="5" show-value block-size="46" @change="setManagerVolume" />
							</div>
						</div>
						<div class="volume-modal-section" v-if="intercomInfo.id">
							...
							<common-icons type="iconvolume" size="32" color="#fff"></common-icons>
							<div class="volume-slider">
								<slider :value="terminalVolume" max="20" show-value block-size="46" @change="setTerminalVolume" />
							</div>
						</div>
					</div>
...
export default {
	...
	methods: {
		...
		async getTerminalVolume () {
			...
			let res = await Api.apiCall("get", Api.index.getTerminalVolume, params);
