<template>
  <div class="prisonerInfo-container">
    <div class="prisonerInfo-wrapper">
      ...
      <scroll-view scroll-y="true" class="prisonerInfo-box-scroll">
        <div class="prisonerInfo-list">
          <div class="prisonerInfo-item" v-for="(item, index) in prisonerInfoList" :key="index"
            @click="getPersonDetailById(item.id)">
            <div class="item-image-box">
              <image :src="item.imgUrl" alt="image"></image>
              <div class="item-mark">
                <div :class="item.mzValue == '98'
                  ? 'nation-red'
                  : item.mzValue != '01'
                    ? 'nation-blue'
                    : ''
