			...
			<view class="form">
				...
				<view class="form-row">
					<view class="form-col">
						...
						<view v-if="isShowDetails" class="inside-border text-area" style="overflow: auto;">{{ details.rybhs
						}}</view>
				...
				<view class="form-row">
					<view class="form-col">
						...
						<view v-if="isShowDetails" class="inside-border input">{{ details.dateTime | dateFormatFilter }}
						</view>
