<template>
	<div class="show-box" :class="{ disabled: disabled, active: isShowList }" :style="style_Container">
		...
		<!-- 显示框 -->
		<div v-else :style="'width:' + widthStyle + 'upx;'" class="input" :class="{ placeholder: selectText === placeholder }"
			@click="onUpperClick">{{ selectText }}</div>
		...
		<div class="list-container" @click.stop="onListClick"
			...
			<scroll-view class="list" style="background-color: rgba(42,66,115,0.95);"
				:style="'max-height: ' + listBoxHeight__ + 'em;'" scroll-y=true scroll-x=true>
